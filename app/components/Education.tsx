    ...
    return (
        <div className="bg-gradient-to-b from-gray-900 to-gray-950 min-h-screen">
            <div className="max-w-6xl mx-auto px-4 py-12">
                ...
                {/* Degrees */}
                <motion.section
                    className="mb-12 px-4 py-8 rounded-xl bg-gray-900 shadow-sm"
                            ...
                            >
                                ...
                                {edu.pdf && (
                                    <button
                                        ...
                                        className="mt-2 cursor-pointer text-blue-600 hover:underline hover:text-blue-400 transition duration-200 text-sm font-medium"
                                    >
                ...
                {/* Certifications */}
                <motion.section
                    className="mb-12 px-4 py-8 rounded-xl bg-gray-800 shadow-sm"
                    initial={{ opacity: 0, y: 80 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.7 }}
                    viewport={{ once: false, amount: 0.3 }}
                ...
                {/* Internships */}
                <motion.section
                    className="px-4 py-8 rounded-xl bg-gray-800 shadow-sm"
                    initial={{ opacity: 0, y: 80 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.7 }}
                    viewport={{ once: false, amount: 0.3 }}
                    ...
                    <div className="relative border-l border-gray-600 ml-4">
                        {internships.map((job, i) => (
                            <motion.div
                                ...
                                viewport={{ once: false, amount: 0.3 }}
                                className="cursor-pointer border border-cyan-500/20 shadow-md mt-2 p-6 rounded-2xl transition duration-300 hover:shadow-lg hover:border-cyan-400 hover:bg-gradient-to-br hover:from-cyan-500/10 hover:via-blue-500/10 hover:to-indigo-500/10 bg-gray-900/80 backdrop-blur-sm hover:ring-1 hover:ring-cyan-400/50">
                                <div className="absolute w-3 h-3 bg-blue-600 rounded-full -left-1.5 top-2.5"></div>
                                <div className="bg-gray-900 px-1 py-2 rounded-lg shadow-sm border border-gray-700">
                    ...
                    >
                        <div className="flex items-center justify-center min-h-screen p-6">
                            <motion.div
                                ...
                                className="bg-gray-900 p-4 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-auto"
                            >
